...
<div dir='rtl' className='py-[80px] bg-gray-100'>
...
<div className="flex justify-center items-center  ">
  <div dir='rtl' className="container mx-auto px-6">
    ...
    <div dir='rtl' className="justify-start items-center text-center mb-12">
      <h2 className="text-4xl font-extrabold text-gray-800 mb-4">نحن ملتزمون بالجودة والابتكار</h2>
    </div>
...
<div dir='rtl' className="bg-lime-100 p-6 ">
  <div className='flex flex-col justify-start'>

        <h4 className="text-xl font-semibold text-gray-800 mb-4">شهاداتنا</h4>
        <p className="text-base text-gray-600">نحن نفخر بالحصول على هذه الشهادات التي تضمن لك منتجاتنا عالية الجودة:</p>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2  px-4">
  <div className=" p-6 sm:p-8  flex flex-col items-center min-h-[400px]">
    <div className="w-full flex justify-center mb-4 bg-secondaryLight p-4">
  ...
  <div className=" p-6 sm:p-8    flex flex-col items-center min-h-[400px]">
    <div className="w-full flex justify-center mb-4 bg-secondaryLight p-4">
      <img src={hala} alt="Halal Certification" className="h-32 sm:h-12 w-auto" />
    </div>
    <div className="bg-secondaryLight w-full p-4 rounded-lg flex flex-col items-center text-white">
      <div className="flex items-center justify-center mb-4">
